...
public class PackedMsgBak {
	 ...
	 * @return
	 */
	public static PackedMsgBak newTDMsg() {
	 ...
	 * @return
	 */
	public static PackedMsgBak newTDMsg(boolean compress) {
	 ...
	 * @return
	 */
	public static PackedMsgBak newTDMsg(int v) {
	 ...
	 * @return
	 */
	public static PackedMsgBak newTDMsg(boolean compress, int v) {
	 ...
	 * @return
	 */
	public static PackedMsgBak newTDMsg(int capacity, boolean compress) {
		return new PackedMsgBak(capacity, compress, Version.v1);
	}
	 ...
	 * @return
	 */
	public static PackedMsgBak newTDMsg(int capacity, boolean compress, int v) {
		return new PackedMsgBak(capacity, compress, Version.of(v));
	}

	// for create
	private PackedMsgBak(int capacity, boolean compress, Version v) {
		version = v;
		addmode = true;
	...
	// for parsed
	private PackedMsgBak(ByteBuffer buffer, Version magic) throws IOException {
		version = magic;
		addmode = false;
		CAPACITY = 0;
	...
	public static PackedMsgBak parseFrom(byte[] data) {
		return parseFrom(ByteBuffer.wrap(data));
	}

	public static PackedMsgBak parseFrom(ByteBuffer buffer) {
		...
		try {
			return new PackedMsgBak(buffer, magic);
		} catch (IOException e) {
			return null;
		}
	}
