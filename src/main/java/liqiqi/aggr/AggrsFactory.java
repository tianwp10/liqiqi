...
public class AggrsFactory {
	...
	public static AggrMap<AggrKey, AggrValue, AggrResult> getAggrProcessor(
			String funcname) {
		return new AggrMap<AggrKey, AggrValue, AggrResult>(getUpdater(funcname));
	}

	public static AggrMap<AggrKey, ArrayList<AggrValue>, ArrayList<AggrResult>> getAggrProcessor(
			final ArrayList<String> funcnames) {

		return new AggrMap<AggrKey, ArrayList<AggrValue>, ArrayList<AggrResult>>(
				new Updater<AggrKey, ArrayList<AggrValue>, ArrayList<AggrResult>>() {
	...
	final static private HashMap<String, Updater<AggrKey, AggrValue, AggrResult>> func2Updaters = new HashMap<String, Updater<AggrKey, AggrValue, AggrResult>>();
	static {
		func2Updaters.put("sum", new Updater<AggrKey, AggrValue, AggrResult>() {

			@Override
			public AggrResult update(AggrKey k, AggrValue v, AggrResult finalv) {
		...
		func2Updaters.put("count",
				new Updater<AggrKey, AggrValue, AggrResult>() {
		...
		func2Updaters.put("max", new Updater<AggrKey, AggrValue, AggrResult>() {
		...
		func2Updaters.put("min", new Updater<AggrKey, AggrValue, AggrResult>() {
		...
		func2Updaters.put("avg", new Updater<AggrKey, AggrValue, AggrResult>() {
	...
	private static Updater<AggrKey, AggrValue, AggrResult> getUpdater(
			String funcname) {
	...
	public static void main(String[] args) {
		...
		funcnames.add("count");
		funcnames.add("sum");
		AggrMap<AggrKey, ArrayList<AggrValue>, ArrayList<AggrResult>> map_5s = getAggrProcessor(funcnames);
		...
		map_5s.add(new AggrKey(gbks, time5s), new ArrayList<AggrValue>() {
			{
				add(new AggrValue("100"));
				add(new AggrValue("100"));
			}
		});
		map_5s.add(new AggrKey(gbks, time5s), new ArrayList<AggrValue>() {
			{
				add(new AggrValue("200"));
				add(new AggrValue("200"));
			}
		});
		map_5s.add(new AggrKey(gbks, time5s), new ArrayList<AggrValue>() {
			{
				add(new AggrValue("300"));
				add(new AggrValue("300"));
			}
		});
		map_5s.add(new AggrKey(gbks, time5s), new ArrayList<AggrValue>() {
			{
				add(new AggrValue("400"));
				add(new AggrValue("400"));
			}
		});
		System.out
